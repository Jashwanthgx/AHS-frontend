  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-inter">
      ...
      <main className="flex-grow flex items-center justify-center p-6 w-full">
        <div className="w-full max-w-[400px] sm:min-w-[380px] shrink-0 bg-white rounded-2xl shadow-lg border border-slate-200 p-8 text-center">
          ...
          <p className="text-slate-500 mb-8">
            Sign in to manage your job listings, review AI-parsed candidate profiles, and streamline your hiring process.
          </p>
          ...
          <form className="flex flex-col gap-4 text-left" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input 
                type="email" 
                className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
