...
export default function ApplyPage() {
  ...
  useEffect(() => {
    const { resumeName, ...rest } = formData;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submissionData.append("custom_answers", JSON.stringify(customAnswersObj));
      submissionData.append("resume", resumeFile);

      const response = await axios.post("http://127.0.0.1:8000/api/v1/apply", submissionData, {
        headers: {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-inter">
      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
          ...
          <div className="hidden md:flex items-center gap-2 text-sm font-medium text-slate-500 bg-slate-50 px-4 py-1.5 rounded-full border border-slate-100">
            <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
            Applying for: <span className="text-slate-900 font-bold ml-1">{selectedJob?.title || "General Application"}</span>
          </div>
        </div>
      </nav>
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6">
        <div className="max-w-3xl w-full bg-white rounded-[32px] shadow-2xl shadow-blue-600/5 border border-slate-200 p-8 md:p-12 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="col-span-full">
                  ...
                  <input 
                    required 
                    type="text" 
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400"
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">GitHub / Portfolio URL</label>
                  <input 
                    required 
                    type="url" 
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400"
            ...
            {step === 2 && (
              <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-3">Resume / CV (PDF Only)</label>
                  <div 
                    className={`w-full border-2 border-dashed rounded-[24px] p-12 flex flex-col items-center justify-center gap-4 transition-all cursor-pointer relative group ${
                      isDragging 
                        ...
                        : "border-slate-200 hover:border-blue-600/30 hover:bg-slate-50"
                    }`}
              ...
              <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select 
                      required
                      className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium appearance-none cursor-pointer"
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">Core Skills</label>
                  <input 
                    required
                    type="text" 
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400"
                  ...
                  />
                  <p className="text-slate-400 text-xs mt-2 font-medium">Separate multiple skills with commas</p>
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">Brief Professional Summary</label>
                  <textarea 
                    rows={4}
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400 resize-none h-28"
            ...
            {step === 4 && (
              <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">Why are you interested in joining {selectedJob?.company || "us"}?</label>
                  <textarea 
                    required
                    rows={4}
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400 resize-none h-28"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-slate-900 mb-2">Notice Period</label>
                    <select 
                      required
                      className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium appearance-none cursor-pointer"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-slate-900 mb-2">Salary Expectation (Annual)</label>
                    <input 
                      type="text" 
                      className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 outline-none transition-all bg-slate-50 text-slate-900 font-medium placeholder:text-slate-400"
              ...
              <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="p-6 bg-slate-50 rounded-[24px] border border-slate-100">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-slate-900 font-bold">{formData.location || "N/A"}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-slate-50 rounded-[24px] border border-slate-100">
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-col">
                        ...
                        <span className="text-slate-900 font-bold">{formData.experience} Years</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] text-slate-400 font-bold uppercase">Domain</span>
                        <span className="text-slate-900 font-bold capitalize">{formData.domain}</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] text-slate-400 font-bold uppercase">Skills</span>
                        <span className="text-slate-900 font-bold">{formData.skills}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 bg-blue-50/50 rounded-[24px] border border-blue-100">
                  <div className="flex items-start gap-4">
                    ...
                    />
                    <label htmlFor="review-antibias" className="text-sm font-medium text-slate-700 cursor-pointer leading-relaxed">
            ...
            {/* Action Buttons */}
            <div className="flex items-center justify-between mt-6 pt-8 border-t border-slate-100">
              <button 
                type="button" 
                disabled={isSubmitting}
                onClick={step > 1 ? prevStep : () => navigate(-1)}
                className="px-8 py-4 rounded-2xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition-all disabled:opacity-50 cursor-pointer"
              >
                {step === 1 ? "Cancel" : "Back"}
              </button>
              ...
              <button 
                type="submit" 
                disabled={isSubmitting}
                className={`px-10 py-4 rounded-2xl font-bold flex items-center gap-3 transition-all active:scale-95 shadow-xl shadow-blue-600/10 cursor-pointer ${
      ...
      {/* Simple Footer */}
      <footer className="w-full py-8 text-center text-xs text-slate-400 font-medium">
